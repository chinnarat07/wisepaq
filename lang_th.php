...
define('page_index_virtualiz_1','Sangfor HCI เป็นโซลูชัน Hyper-Converged Infrastructure (HCI) ที่พัฒนาโดย Sangfor เป็นโซลูชัน Data centre ในรูปแบบ Software-defined ที่ใช้งานง่ายใน Console เดียว โดยการรวมความสามารถของทั้ง Compute, Storage, Networking และ Security ไว้ในชุดซอฟต์แวร์ชุดเดียว พร้อมให้บริการ Data Center ทุกระดับทั้งองค์กรขนาดเล็กไปจนถึงองค์กรขนาดใหญ่');
define('page_index_virtualiz_2','Nutanix เป็นบริษัทซอฟต์แวร์และอุปกรณ์เกี่ยวกับ Cloud รวมถึงการออกแบบ Solution ทั้งระบบที่มีความเชี่ยวชาญด้านการจัดการพื้นที่จัดเก็บข้อมูลและการจัดการเครือข่าย ซึ่งผลิตภัณฑ์หลักของ Nutanix คือ Hyper-Converged Infrastructure (HCI) นอกจากนี้ Nutanix ยังมี Hyper Converged Infrastructure สำหรับตู้เซิร์ฟเวอร์และเครื่องมือต่าง ๆ ที่ช่วยให้ผู้ใช้งานสามารถจัดการและควบคุมระบบได้ง่ายและมีประสิทธิภาพสูงสุด');
define('page_index_virtualiz_3','ระบบ Microsoft คือชุดของผลิตภัณฑ์และบริการต่างๆ ที่พัฒนาโดย Microsoft ซึ่งรวมถึงระบบปฏิบัติการ Windows, ซอฟต์แวร์สำนักงาน Microsoft Office, แพลตฟอร์มคลาวด์ Azure, และเครื่องมืออื่นๆ ที่ช่วยในการจัดการข้อมูล, การทำงานร่วมกัน, และการใช้งานเทคโนโลยีในองค์กรและชีวิตประจำวัน.');
define('page_index_virtualiz_4','VMware คือซอฟต์แวร์ virtualization ที่ช่วยให้คุณสามารถสร้างและจัดการเครื่องคอมพิวเตอร์เสมือน (virtual machine) บนฮาร์ดแวร์เครื่องเดียวได้หลายเครื่อง การช่วยให้ผู้ใช้งานสามารถสร้างและจัดการระบบเสมือนจริงบนเซิร์ฟเวอร์เดียวได้ ทำให้การใช้ทรัพยากรเกิดประสิทธิภาพสูงสุด ลดต้นทุน และเพิ่มความยืดหยุ่นในการบริหารจัดการระบบไอที');
...
define('page_software_2','ระบบสายเรือ');
define('page_software_3','ระบบ อะไหล่');
define('page_software_4','ระบบ โรงงาน');
define('page_software_5','ERP');
define('page_software_6','ระบบ DEPOT');
define('page_software_7','ระบบ เวชระเบียน โรงพยาบาล');
define('page_software_8','ระบบหอพัก');
define('page_software_9','Nabour');
define('page_software_10','ETC.');
define('page_software_11','สิ่งที่เรามี');
